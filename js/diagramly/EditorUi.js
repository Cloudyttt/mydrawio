...
(function () {
  ...
  (function () {
    ...
    try {
      ...
      var svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1px" height="1px" version="1.1">' +
        '<foreignObject pointer-events="all" width="1" height="1"><div xmlns="http://www.w3.org/1999/xhtml"></div></foreignObject></svg>';
  ...
  EditorUi.prototype.downloadFile = function (format, nonCompressed, addShadow, ignoreSelection, currentPage, pageVisible, transparent) {
    console.log('asd');
    try {
      console.log('nonCompressed-1', nonCompressed);
    ...
    if (file.isEditable()) {
      ...
      if (Graph.fileSupport) {
        mxEvent.addListener(contentDiv, 'dragover', mxUtils.bind(this, function (evt) {
          console.log('diagramly ==> dragover~~~');
          contentDiv.style.backgroundColor = '#f1f3f4';
        ...
        mxEvent.addListener(contentDiv, 'dragleave', function (evt) {
          console.log('diagramly ==> dragleave~~~');
          contentDiv.style.cursor = '';
          contentDiv.style.backgroundColor = '';
          evt.stopPropagation();
          evt.preventDefault();
...
//				}));
  ...
  EditorUi.prototype.showImageDialog = function (title, value, fn, ignoreExisting, convertDataUri) {
    ...
    console.log('diagramly/EditorUi中创建了一个ImageDialog...');
