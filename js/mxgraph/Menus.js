...
Menus.prototype.init = function () {
  ...
  this.put('direction', new Menu(mxUtils.bind(this, function (menu, parent) {
    menu.addItem(mxResources.get('flipH'), null, function () {  // 水平翻转
      graph.toggleCellStyles(mxConstants.STYLE_FLIPH, false);
    }, parent);
    menu.addItem(mxResources.get('flipV'), null, function () {  // 垂直翻转
      graph.toggleCellStyles(mxConstants.STYLE_FLIPV, false);
    }, parent);
    this.addMenuItems(menu, ['-', 'rotation'], parent); // 旋转
  })));
  // 对齐
  ...
  this.put('layout', new Menu(mxUtils.bind(this, function (menu, parent) {
    ...
    menu.addItem(mxResources.get('horizontalFlow'), null, mxUtils.bind(this, function () {  // 水平流动
    ...
    menu.addItem(mxResources.get('verticalFlow'), null, mxUtils.bind(this, function () {  //  垂直流
    ...
    menu.addSeparator(parent);
    menu.addItem(mxResources.get('horizontalTree'), null, mxUtils.bind(this, function () {  // 水平树状
    ...
    menu.addItem(mxResources.get('verticalTree'), null, mxUtils.bind(this, function () {  // 垂直树状
      var tmp = graph.getSelectionCell();
      var roots = null;
    ...
    menu.addItem(mxResources.get('radialTree'), null, mxUtils.bind(this, function () {  径向树
      var tmp = graph.getSelectionCell();
      var roots = null;
    ...
    menu.addSeparator(parent);
    menu.addItem(mxResources.get('organic'), null, mxUtils.bind(this, function () { // 力导向分布图
    ...
    menu.addItem(mxResources.get('circle'), null, mxUtils.bind(this, function () {  // 圆形
  ...
  this.put('arrange', new Menu(mxUtils.bind(this, function (menu, parent) {
    this.addMenuItems(menu, ['cutImageTool', '-'], parent);
  ...
  this.put('view', new Menu(mxUtils.bind(this, function (menu, parent) {
    ...
    console.log('mxgraph/menu.js/400');
  })));
  // Two special dropdowns that are only used in the toolbar.两个仅在工具栏中使用的特殊下拉列表
  // 查看面板
  this.put('viewPanels', new Menu(mxUtils.bind(this, function (menu, parent) {
    ...
    console.log('mxgraph/menu.js/410')
  })));
...
/**
 * Adds a checkmark to the given menuitem.添加快捷键函数
 */
...
/**
 * Creates the keyboard event handler for the current graph and history.添加目录函数
 */
...
Menus.prototype.createPopupMenu = function (menu, cell, evt) {
  ...
  if (!graph.isSelectionEmpty()) {
    ...
    if (state != null) {
      ...
      console.log('mxgraph/Menus.js/893');
      if (graph.getModel().isEdge(cell) && mxUtils.getValue(state.style, mxConstants.STYLE_EDGE, null) != 'entityRelationEdgeStyle' &&
        ...
        /*this.addMenuItem(menu, 'cutImageTool', null, evt, null, mxResources.get('cutImageTool'));*/
