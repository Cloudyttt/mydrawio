...
/*mxEdgeHandler.prototype.isRotationHandleVisible = function () {
...
mxEdgeHandler.prototype.isSizerVisible = function (index) {
	return true;
};
...
mxEdgeHandler.prototype.createSizer = function (cursor, index, size, fillColor) {
...
mxEdgeHandler.prototype.init = function () {
  ...
  console.log('this.abspoints', this.abspoints);
  // console.log('this.abspoints', this.abspoints);
...
mxEdgeHandler.prototype.mouseMove = function (sender, me) {
  if (this.index != null && this.marker != null) {
    /*
    * this.currentPoint => 正在拖动的点的坐标
    * this.startX => 鼠标按下时位置（相对于整个屏幕）
    * this.startY => 鼠标按下时位置（相对于整个屏幕）
    * */
    this.currentPoint = this.getPointForEvent(me);
    this.error = null;
    // console.log('this.startX', this.startX);
    // console.log('this.startY', this.startY);
    // console.log('this.currentPoint-1', this.currentPoint);
    ...
    // console.log('this.currentPoint-2', this.currentPoint);
    ...
    if (this.index <= mxEvent.CUSTOM_HANDLE && this.index > mxEvent.VIRTUAL_HANDLE) {
      ...
      } else if (this.outlineConnect) {	// => false
        // console.log('case-5');
      ...
      this.updatePreviewState(this.state, this.currentPoint, terminalState, me, outline);

      // for(let i = 0; i < this.state.absolutePoints.length; i++){
      //   this.state.absolutePoints[i].x += 1;
      //   this.state.absolutePoints[i].y += 1;
      // }

      // for(let i = 0; i < this.abspoints.length; i++){
      //   this.abspoints[i].x += 1;
      //   this.abspoints[i].y += 1;
      // }
    ...
    // this.updateHint(me, this.currentPoint); // 提示
