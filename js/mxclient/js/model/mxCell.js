 ...
 *
 * Specifies whether the cell is connectable. Default is false.
 */
 ...
 * Variable: source
 *
 * Reference to the source terminal. 对源终端的引用
 */
 ...
 * Variable: target
 *
 * Reference to the target terminal. 对目标终端的引用。
 */
 ...
 * the language.
 * 不应在<clone>内克隆的成员列表。
 * 此字段将传递给<mxutils.clone>，并且不会在<mxcellcodec>中持久化。
 * 这不是所有类的约定，因为语言不支持临时修饰符，所以只能在此类中使用它来标记临时字段。
 */
