 ...
 * 扩展<mxshape>以实现图像形状。
 * 此形状在<mxCellRenderer>中的<mxConstants.shape_image>下注册。
 *
 ...
 * <mxShape.bounds>.<mxRectangle>定义边界。
 * image - String that specifies the URL of the image. This is stored in <image>.
 * fill - String that defines the fill color. This is stored in <fill>.定义填充颜色的字符串。
 * stroke - String that defines the stroke color. This is stored in <stroke>.String类型字符串，定义绘制颜色。
 * strokewidth - Optional integer that defines the stroke width. Default is 0. This is stored in <strokewidth>.定义绘制的线条宽度，默认为0
 */
