...
var mxEvent =
{
	 ...
	 * Function: consume
	 * 
	 * Consumes the given event.使用给定的事件。
	 * 
	 * Parameters:
	 * 
	 * evt - Native event to be consumed.要使用的本地事件。
	 * preventDefault - Optional boolean to prevent the default for the event.可选布尔值以防止事件的默认值。
	 * Default is true.
