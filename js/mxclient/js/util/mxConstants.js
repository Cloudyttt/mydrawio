 ...
 */
 var mxConstants =
 {
	 ...
	 *
	 * Defines the portion of the cell which is to be used as a connectable.定义要用作可连接的元格部分
  ...
  /*
  * Variable: STYLE_GRAYSCALE
  *
  * */
  STYLE_GRAYSCALE: 'grayscale',
	...
	*/
	 ...
	 * 定义图像背景颜色的键。此样式仅在<mxImageShape>中使用。可能的值都是HTML颜色名称或十六进制代码。值为“ImageBackground”。
	 */
 ...
 /**
	* Variable: STYLE_ISMULTIPLY
	* 正片叠底
	*/
  STYLE_ISMULTIPLY: 'isMultiply',
