...
mxDragSource.prototype.dragOver = function (graph, evt) {
  ...
  var x = mxEvent.getClientX(evt) - offset.x + origin.x - graph.panDx; // x坐标
  var y = mxEvent.getClientY(evt) - offset.y + origin.y - graph.panDy; // y坐标
  ...
  // Highlights the drop target under the mouse 高亮当前正在拖动的目标
