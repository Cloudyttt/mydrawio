...
(function () {
  ...
  Editor.commonEdgeProperties = [
    {type: 'separator'},
    {name: 'arcSize', dispName: '弧度', type: 'float', min: 0, defVal: mxConstants.LINE_ARCSIZE},
    {
      name: 'targetPortConstraint', dispName: '目标端口约束', type: 'enum', defVal: 'none',
      enumList: [{val: 'none', dispName: '无'}, {val: 'east', dispName: '右'}, {
        val: 'north',
        dispName: '上'
      }, {val: 'south', dispName: '下'}, {val: 'west', dispName: '左'}]
    },
    {
      name: 'sourcePortConstraint', dispName: '源端口约束', type: 'enum', defVal: 'none',
      enumList: [{val: 'none', dispName: '无'}, {val: 'east', dispName: '右'}, {
        val: 'north',
        dispName: '上'
      }, {val: 'south', dispName: '下'}, {val: 'west', dispName: '左'}]
    },
    {name: 'fillOpacity', dispName: '填充不透明度', type: 'int', min: 0, max: 100, defVal: 100},
    {name: 'strokeOpacity', dispName: '绘制不透明度', type: 'int', min: 0, max: 100, defVal: 100},
    {name: 'startFill', dispName: '开始填充', type: 'bool', defVal: true},
    {name: 'endFill', dispName: '结束填充', type: 'bool', defVal: true},
    {name: 'sourcePerimeterSpacing', dispName: '源周边间距', type: 'float', defVal: 0},
    {name: 'targetPerimeterSpacing', dispName: '目标周边间距', type: 'float', defVal: 0},
    {name: 'perimeterSpacing', dispName: '周边间距', type: 'float', defVal: 0},
    {name: 'anchorPointDirection', dispName: '锚点方向n', type: 'bool', defVal: true},
    {name: 'snapToPoint', dispName: '捕捉点', type: 'bool', defVal: false},
    {name: 'fixDash', dispName: '固定破折号', type: 'bool', defVal: false},
    {
      name: 'jiggle', dispName: '抖动', type: 'float', min: 0, defVal: 1.5, isVisible: function (state) {
        return mxUtils.getValue(state.style, 'comic', '0') == '1';
      }
    },
    {name: 'editable', dispName: '编辑', type: 'bool', defVal: true},
    {name: 'backgroundOutline', dispName: '背景轮廓', type: 'bool', defVal: false},
    {name: 'bendable', dispName: '弯曲', type: 'bool', defVal: true},
    {name: 'movable', dispName: '移动', type: 'bool', defVal: true},
    {name: 'cloneable', dispName: '复制', type: 'bool', defVal: true},
    {name: 'deletable', dispName: '删除', type: 'bool', defVal: true},
    {name: 'orthogonalLoop', dispName: '环路路由', type: 'bool', defVal: false},
    {name: 'noJump', dispName: '无跳跃', type: 'bool', defVal: false}
  ];
  ...
  Editor.commonVertexProperties = [
    ...
    {name: 'strokeOpacity', dispName: '绘制不透明度', type: 'int', min: 0, max: 100, defVal: 100},
    {
      name: 'overflow', dispName: '文本溢出', defVal: 'visible', type: 'enum',
      enumList: [{val: 'visible', dispName: '可视'}, {val: 'hidden', dispName: '隐藏'}, {
        val: 'fill',
        dispName: '充满'
      }, {val: 'width', dispName: '加宽'}]
    },
    {name: 'noLabel', dispName: '隐藏标签', type: 'bool', defVal: false},
    {name: 'labelPadding', dispName: '标签内边距', type: 'float', defVal: 0},
    {
      name: 'direction', dispName: '方向', type: 'enum', defVal: 'east',
      enumList: [{val: 'east', dispName: '右'}, {val: 'north', dispName: '上'}, {
        val: 'south',
        dispName: '下'
      }, {val: 'west', dispName: '左'}]
    },
    {
      name: 'portConstraint', dispName: '端口约束', type: 'enum', defVal: 'none',
      enumList: [{val: 'none', dispName: '无'}, {val: 'east', dispName: '右'}, {
        val: 'north',
        dispName: '上'
      }, {val: 'south', dispName: '下'}, {val: 'west', dispName: '左'}]
    },
    {name: 'portConstraintRotation', dispName: '端口旋转约束', type: 'bool', defVal: false},
    {name: 'connectable', dispName: '可连接', type: 'bool', defVal: 0},
    {name: 'snapToPoint', dispName: '捕捉点', type: 'bool', defVal: false},
    {
      name: 'perimeter', dispName: '周边', defVal: 'none', type: 'enum',
      enumList: [{val: 'none', dispName: '无'},
        {val: 'rectanglePerimeter', dispName: '矩形'}, {val: 'ellipsePerimeter', dispName: '椭圆'},
        {val: 'rhombusPerimeter', dispName: '菱形'}, {val: 'trianglePerimeter', dispName: '三角形'},
        {val: 'hexagonPerimeter2', dispName: '六边形'}, {val: 'lifelinePerimeter', dispName: '网格'},
        {val: 'orthogonalPerimeter', dispName: '正交'}, {val: 'backbonePerimeter', dispName: '干线'},
        {val: 'calloutPerimeter', dispName: '标注'}, {val: 'parallelogramPerimeter', dispName: '平行四边形'},
        {val: 'trapezoidPerimeter', dispName: '梯形'}, {val: 'stepPerimeter', dispName: '步骤'}]
    },
    {name: 'fixDash', dispName: '固定破折号', type: 'bool', defVal: false},
    {
      name: 'jiggle', dispName: '抖动', type: 'float', min: 0, defVal: 1.5, isVisible: function (state) {
    ...
    {name: 'autosize', dispName: '自适应大小', type: 'bool', defVal: false},
    {name: 'collapsible', dispName: '折叠', type: 'bool', defVal: false},
    {name: 'container', dispName: '容器', type: 'bool', defVal: false},
    {name: 'recursiveResize', dispName: '调整子级大小', type: 'bool', defVal: true},
    {name: 'part', dispName: '隔离', type: 'bool', defVal: false},
    {name: 'editable', dispName: '编辑', type: 'bool', defVal: true},
    {name: 'backgroundOutline', dispName: '背景轮廓', type: 'bool', defVal: false},
    {name: 'movable', dispName: '移动', type: 'bool', defVal: true},
    {name: 'resizable', dispName: '调整大小', type: 'bool', defVal: true},
    {name: 'resizeWidth', dispName: '调整宽度', type: 'bool', defVal: false},
    {name: 'resizeHeight', dispName: '调整高度', type: 'bool', defVal: false},
    {name: 'rotatable', dispName: '旋转', type: 'bool', defVal: true},
    {name: 'cloneable', dispName: '克隆', type: 'bool', defVal: true},
    {name: 'deletable', dispName: '删除', type: 'bool', defVal: true}
  ];
  /**
  ...
  Editor.prototype.setGraphXml = function (node) {
    ...
    if (node != null) {
      ...
      if (errs != null && errs.length > 0) {
        ...
        this.graph.setShadowVisible(true/*node.getAttribute('shadow') == '1', false*/);
      }
...
//					svgRoot.parentNode.removeChild(svgRoot);
   ...
   *
   */
  Editor.prototype.exportToCanvas = function (callback, width, imageCache, background, error, limitHeight, ignoreSelection, scale, transparentBackground, addShadow, converter, graph, border, noCrop) {
    ...
    this.convertImages(graph.getSvg(bg, null, null, noCrop, null, ignoreSelection, null, null, null, addShadow),
      mxUtils.bind(this, function (svgRoot) {
        ...
        /*this.addSvgGrayscale(svgRoot); // 灰度*/
  ...
  if (window.StyleFormatPanel != null) {
    ...
    mxCellRenderer.defaultShapes['image'].prototype.customProperties = [
      {name: 'imageAspect', dispName: '固定图形方面', type: 'bool', defVal: true}
    ];

    mxCellRenderer.defaultShapes['label'].prototype.customProperties = [
      {name: 'imageAspect', dispName: '固定图形方面', type: 'bool', defVal: true},
      {
        name: 'imageAlign', dispName: '图形对齐', type: 'enum',
        enumList: [{val: 'left', dispName: '左'},
          {val: 'center', dispName: '中'},
          {val: 'right', dispName: '右'}], defVal: 'left'
      },
      {
        name: 'imageVerticalAlign', dispName: '图形垂直对齐', type: 'enum',
        enumList: [{val: 'top', dispName: '上'},
          {val: 'middle', dispName: '中'},
          {val: 'bottom', dispName: '下'}], defVal: 'middle'
      },
      {name: 'imageWidth', dispName: '图形宽度', type: 'float', min: 0, defVal: 24},
      {name: 'imageHeight', dispName: '图形高度', type: 'float', min: 0, defVal: 24},
      {name: 'arcSize', dispName: '弧度', type: 'float', min: 0, defVal: 12},
      {name: 'absoluteArcSize', dispName: '绝对弧度', type: 'bool', defVal: false}
    ];
    ...
    StyleFormatPanel.prototype.addProperties = function (div, properties, state) {
      ...
      function createCheckbox(pName, pValue, prop) {
        ...
        mxEvent.addListener(input, 'change', function () {
          ...
          /*if(pName === 'isMultiply'){
            console.log(pName);
            console.log('newVal: ', input.checked ? '1' : '0');
  ...
  Graph.prototype.grayscaleId = 'grayscale';
  ...
  Graph.prototype.getSvg = function () {
    var temp = null;
    console.log('getSvg in myapp/Editor/getSvg()');
    if (this.themes != null && this.defaultThemeName == 'darkTheme') { // false
      console.log('黑色主题...');
  ...
  Graph.prototype.addSvgShadow = function (svgRoot, group, createOnly) {
    ...
    var filter2 = (svgDoc.createElementNS != null) ? svgDoc.createElementNS(mxConstants.NS_SVG, 'filter') : svgDoc.createElement('filter');
    filter2.setAttribute('id', this.grayscaleId);
    filter2.setAttribute('x', '0');
    filter2.setAttribute('y', '0');

    var gray = (svgDoc.createElementNS != null) ? svgDoc.createElementNS(mxConstants.NS_SVG, 'feColorMatrix') : svgDoc.createElement('feColorMatrix');
    gray.setAttribute('type', 'matrix');
    gray.setAttribute('values', "0.3333 0.3333 0.3333 0 0 0.3333 0.3333 0.3333 0 0 0.3333 0.3333 0.3333 0 0 0 0 0 1 0");
    filter2.appendChild(gray);


    // Creates defs element if not available 创建defs元素（如果不可用）
    ...
    if (defs.length == 0) {
      ...
      if (svgRoot.firstChild != null) {
        ...
        console.log('svgRoot.firstChild',svgRoot.firstChild);
      } else {
    ...
    defsElt.appendChild(filter2);

    // console.log('svgRoot in addShadow', svgRoot);
    // console.log('defs', defs);
    // console.log('defsElt', defsElt);


    if (!createOnly) {
      // console.log('createOnly === false');
    ...
    /*this.addSvgGrayscale(svgRoot);*/
    console.log('filter in addShadow', filter);
    return filter;
  };

  /**
   * Adds a grayscale filter to the given svg root.
   */
  // Graph.prototype.addSvgGrayscale = function (svgRoot, group, createOnly) {
  //   createOnly = (createOnly != null) ? createOnly : false;
  //
  //   var svgDoc = svgRoot.ownerDocument;
  //
  //   var filter = (svgDoc.createElementNS != null) ? svgDoc.createElementNS(mxConstants.NS_SVG, 'filter') : svgDoc.createElement('filter');
  //   filter.setAttribute('id', this.grayscaleId);
  ...
  PrintDialog.prototype.create = function (editorUi, titleText) {
    ...
    pageScaleInput.setAttribute('value', '124 %');
    ...
    function preview(print) {
      ...
      function printGraph(thisGraph, pv, forcePageBreaks) {
        ...
        console.log('printGraph函数...');
        // graph = (graph != null) ? graph : this.graph;
        // let svgRoot = graph.getSvg(bg, null, null, null, null, true);
        // console.log('svgRoot in printGraph', svgRoot); // svgRoot正常显示
        // console.log('thisGraph-1', thisGraph);
        // thisGraph.addSvgShadow(svgRoot);
        // console.log('thisGraph-2', thisGraph);
        // Negative coordinates are cropped or shifted if page visible
        var gb = thisGraph.getGraphBounds(); // mxRectangle
        // console.log('gb', gb);
        var border = 0;
        var x0 = 0;
        var y0 = 0;

        var pf = accessor.get(); // mxRectangle
        // console.log('pf', pf);
        var scale = 1 / thisGraph.pageScale;
        var autoOrigin = fitRadio.checked; // false

        // console.log('autoOrigin', autoOrigin);
        ...
        if (pv == null) { // true
          // console.log('pv == null');
          pv = PrintDialog.createPrintPreview(thisGraph, scale, pf, border, x0, y0, autoOrigin); // 创建预览,此处graph转化为mxPrintPreview.js
          pv.pageSelector = false;
          pv.mathEnabled = false;

          // pv.graph.addSvgShadow(svgRoot);
          ...
          if (typeof (MathJax) !== 'undefined') { // false
            // Adds class to ignore if math is disabled
            console.log('666');
            var printPreviewRenderPage = pv.renderPage; // 渲染页面创建主div容器
            console.log('mxPrintPreview.renderPage返回值：printPreviewRenderPage===> ', printPreviewRenderPage);

            pv.renderPage = function (w, h, dx, dy, content, pageNumber) {
              var prev = mxClient.NO_FO;
              mxClient.NO_FO = (this.graph.mathEnabled && !this.useForeignObjectForMath) ? true : this.originalNoForeignObject;
          ...
          // console.log('000');
          pv.open(null, null, forcePageBreaks, true); // 执行
        } else { // false
      ...
      if (!ignorePages && editorUi.pages != null && editorUi.pages.length) {  // true
        var i0 = 0;
        ...
        for (var i = i0; i <= imax; i++) {
          ...
          if (tempGraph == null) { // false
            console.log('tempGraph == null');
      ...
      if (pv == null) { // false
        ...
        // console.log('pv !== null');
        if (pv.mathEnabled) { // false
          var doc = pv.wnd.document;
          console.log('doc doc doc');
          console.log('pv.wnd.document', pv.wnd.document);
        ...
        if (!pv.mathEnabled && print) { // true
          PrintDialog.printPreview(pv); // 生成预览图后，启动浏览器打印进程
        }
      }
    };
  ...
  ChangePageSetup.prototype.execute = function () {
    ...
    // this.ui.editor.graph.setShadowVisible(true);
    ...
    if (this.page != this.ui.currentPage) {
      if (this.page.viewState != null) {
        ...
        if (this.shadowVisible != null) {
          this.page.viewState.shadowVisible = true/*this.shadowVisible*/;
        }
      }
    } else {
      ...
      if (this.shadowVisible != null && this.shadowVisible != this.ui.editor.graph.shadowVisible) {
        this.ui.editor.graph.setShadowVisible(true/*this.shadowVisible*/);
        this.shadowVisible = true/*!this.shadowVisible*/;
      }
    }
  };
